...
4. **[Clone the repository](https://github.com/HarshendraShah11/Lang_Tutor.git)** from : "https://github.com/HarshendraShah11/Lang_Tutor.git" . 
    
   `bash 
    git clone --recursive https://github.com/HarshendraShah11/Lang_Tutor.git 
    ` 
